"""HTTP service for MadridInstruments."""
...
from madrid_instruments_service.program.load.load_program import load_program
from madrid_instruments_service.program.load.load_program_request import (
    LoadProgramRequest,
)
from madrid_instruments_service.program.load.load_program_response import (
    LoadProgramResponse,
)
from madrid_instruments_service.program.program_id import ProgramId
from madrid_instruments_service.program.run.run_program import run_program
from madrid_instruments_service.program.run.run_program_response import RunProgramResponse

from madrid_instruments_service.dependencies import setup_dependencies
...
@app.post("/program/load", response_model=LoadProgramResponse, status_code=200)
...
@app.get("/program/run/{program_id}", response_model=RunProgramResponse, status_code=200)
...
async def invalid_pulse_sequence_exception_handler(_: Request, ex: InvalidPulseSequenceError):
